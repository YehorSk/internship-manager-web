      ...
      <v-form ref="profileForm" v-model="valid" class="form-fix">
        <v-row>
          ...
          <template v-else-if="role === 'company'">
            ...
            <v-col cols="12" md="6">
              <v-label class="opacity-100"><span class="font-weight-bold">Telefón kontaktnej osoby</span><span class="font-weight-bold text-red ml-2">*</span></v-label>
              <v-text-field
          ...
          <template v-else-if="role === 'supervisor'">
            <v-col cols="12" md="3">
              <v-label class="opacity-100"><span class="font-weight-bold">Titul</span></v-label>
              <v-text-field
                v-model="form.title"
                rounded="lg"
                density="compact"
            ...
            <v-col cols="12" md="5">
              <v-label class="opacity-100"><span class="font-weight-bold">E-mail</span><span class="font-weight-bold text-red ml-2">*</span></v-label>
              <v-text-field
                v-model="form.email"
                rounded="lg"
                density="compact"
...
export default {
  ...
  created() {
    ...
    if (this.role === 'student') {
      ...
      this.form = { ...user.company }
    } else if (this.role === 'supervisor') {
      this.form = { ...user.supervisor }
    }
  },
