              ...
              <div class="pa-6">
                ...
                >
                  <div class="d-flex justify-center flex-wrap ga-2">
                    <v-btn color="#3A803D" class="text-white" rounded="lg" elevation="0">
                      <v-icon start>mdi-check</v-icon> Schváliť
                    </v-btn>
                    <v-btn color="red" class="text-white" rounded="lg" elevation="0">
...
export default {
  ...
  methods: {
    ...
    async cancelPractice() {
      if (!confirm('Naozaj chcete zrušiť túto prax?')) return
      try {
